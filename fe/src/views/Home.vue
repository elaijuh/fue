      ...
      >
        <v-card>
          ...
          <v-list dense>
            ...
            <v-list-tile>
              <v-list-tile-content>Producer:</v-list-tile-content>
              <v-list-tile-content class="align-end">{{ props.item.producer }}</v-list-tile-content>
            </v-list-tile>
            <v-list-tile>
              <v-list-tile-content>Score:</v-list-tile-content>
              <v-list-tile-content class="align-end">{{ props.item.rt_score }}</v-list-tile-content>
            </v-list-tile>
          </v-list>
        </v-card>
      </v-flex>
...
export default {
  ...
  data: () => ({
    ...
    search: '',
    films: [],
    // https://github.com/mazipan/ghibli-fans/blob/master/src/data/film.js
    filmImages: {
  ...
  async created() {
    ...
    let res = await this.$http.get('https://ghibliapi.herokuapp.com/films')
    this.films = res.data
